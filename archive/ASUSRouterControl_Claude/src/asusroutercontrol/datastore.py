...
CREATE INDEX IF NOT EXISTS idx_device_perf_ts ON device_perf_history(timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_client_traffic_ts ON client_traffic(timestamp DESC);
